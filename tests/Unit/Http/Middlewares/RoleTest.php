...
class RoleTest extends TestCase
{
    ...
    public function it_passes_for_user_roles_on_parameters()
    {
        ...
        $this->actingAs($user)->callMiddleware(Role::class.':1|2');
    ...
    public function it_redirects_non_accepted_roles_to_the_home()
    {
        ...
        $this->actingAs($user)->callMiddleware(Role::class.':1');
    ...
    {
        $this->callMiddleware(Role::class.':1');
    ...
    public function it_returns_a_forbidden_json_response_for_non_accepted_roles()
    {
        ...
        $this->actingAs($user)->callMiddlewareJson(Role::class.':1');
    ...
    {
        $this->callMiddlewareJson(Role::class.':1');
